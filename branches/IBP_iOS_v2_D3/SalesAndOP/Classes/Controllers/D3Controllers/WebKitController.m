...
-(void)setupWebView
{
    ...
    NSString *nv = [NSString stringWithContentsOfURL:[[NSBundle mainBundle] URLForResource:@"AmeriGraph" withExtension:@".js"]encoding:NSUTF8StringEncoding error:NULL];
 ...
 */
    ...
    __block NSString *d3Lib = [NSString stringWithContentsOfURL:[[NSBundle mainBundle] URLForResource:@"d3.v3.min" withExtension:@".js"] encoding:NSUTF8StringEncoding error:NULL];
