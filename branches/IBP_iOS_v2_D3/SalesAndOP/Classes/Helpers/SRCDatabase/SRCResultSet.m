...
@interface SRCDatabase ()
- (void)resultSetDidClose:(SRCResultSet *)resultSet;
@end


@interface SRCResultSet (Private)
- (NSMutableDictionary *)columnNameToIndexMap;
- (void)setColumnNameToIndexMap:(NSMutableDictionary *)value;
@end

@implementation SRCResultSet
@synthesize query;
@synthesize columnNameToIndexMap;
@synthesize statement;

+ (id)resultSetWithStatement:(SRCStatement *)statement usingParentDatabase:(SRCDatabase*)aDB {
    
    SRCResultSet *rs = [[SRCResultSet alloc] init];
...
- (void)setParentDB:(SRCDatabase *)newDb {
    parentDB = newDb;
}
