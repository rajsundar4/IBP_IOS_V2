...
//
//  MAXValueCartesianChartBasePainter.h
//  MAKit
//
//  Created by Zhang Jie on 4/20/11.
//  Copyright 2011 SAP AG. All rights reserved.
//

#import <Foundation/Foundation.h>
#import "MAChartBasePainter.h"
#import "MACartesianChartPainter.h"
#import "MAValueBubbleLegendViewDelegate.h"
#import "MATabularCategoryChartBasePainter.h"


/** 
 @ingroup MAKit
 @brief Base painter for charts with values as the x-axis and categories as the y-axis
 */
@interface MAXValueCartesianChartBasePainter : MATabularCategoryChartBasePainter <MAChartBasePainter, MACartesianChartPainter, MAValueBubbleLegendViewDelegate> 
{
    @private
    CGFloat _maxCategoryLabelWidth;
    CGFloat _maxValueLabelWidth;
}

/**
 Gets the height of each category row
 */
