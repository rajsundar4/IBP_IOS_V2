...
//
//  MAAnimatorDelegate.h
//  MADashboard
//
//  Created by Zhang Jie on 10/29/10.
...
/*!
 @ingroup MAKit
 *  \brief Protocol of animators 
 *
 *  This protocol defines methods and properties that needs to be implemented by an animator. 
 *  An animator is responsible for returning an CAAnimation which will be applied onto the UI elements inside the MAKit.
 *  It provides users with a way to customize the animation effect.
 *  Users may implement this protocol to create their own animations.
 */
@protocol MAAnimatorDelegate <NSObject>

@required

/**
 @brief Returns the animation 
 @param layer Layer for which animation is applicable to
 @param duration Animation duration
 @return A CAAnimation for the specified layer
 */
- (CAAnimation*)getAnimationWithLayer:(CALayer*)layer andDuration:(float)duration;
