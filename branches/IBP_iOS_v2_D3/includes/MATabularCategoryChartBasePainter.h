...
//
//  MATabularCategoryChartBasePainter.h
//  MAKit
//
//  Created by Cordelia Lee on 12/5/11.
...
/** 
 *  @ingroup MAKit
 *  @brief Base painter for drawing categories in a tabular format in the left area 
 */
@interface MATabularCategoryChartBasePainter : NSObject<MAChartBasePainter>
...
/**
 The color of the data grid header
 */
- (UIColor*)headerBackgroundColor;

/**
 The color of the data grid text
 */
- (UIColor*)catgeoryTextColor;
