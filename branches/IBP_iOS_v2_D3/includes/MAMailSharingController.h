...
/** 
 @ingroup MAKit
 @brief Class to share an image of a view via an e-mail message.
 */
...
/**
 The string used as the title of the mail.
 */
...
/**
 ...
 @param view The view image used as the mail attachment.
 */
