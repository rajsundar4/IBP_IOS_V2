 ...
 */
//
//  MAMetaDictionaryFactory.h
//  MAKit
//
//  Created by Li Zhao on 12/12/11.
//  Copyright (c) 2011 SAP AG. All rights reserved.
//

#import <Foundation/Foundation.h>
#import "MAMetaDataTable.h"


/** 
 @ingroup MAKit
 @brief Class to construct metadata from property file
 */
@interface MAMetaDictionaryFactory : NSObject

/**
 @brief Populate the metadata table with dictionary obtained from properties file
 @param table Metadata table
 @param metaDict Metadata dictionary
 */
+(void)populateMetaTable:(MAMetaDataTable*)table FromDictionary:(NSMutableDictionary*)metaDict;
