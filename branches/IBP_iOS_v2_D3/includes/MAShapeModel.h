...
/** 
 @ingroup MAKit
 @brief Class of model for shape
 */
@interface MAShapeModel : NSObject {
...
/**
 The width of dash pattern.
 */
@property(nonatomic, assign) CGFloat dashPatternWidth;

/**
 The starting x-coordinate to draw dash pattern.
 */
@property(nonatomic, assign) CGFloat dashStartingXValue;
